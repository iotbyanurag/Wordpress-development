...
class Themify {
	...
	private static $grid3_height = 180;
	
	// Grid2
	private static $grid2_width = 474;
	private static $grid2_height = 250;
	
	// List Large
	private static $list_large_image_width = 680;
	...
	function template_redirect() {
		...
		elseif( is_single() ) {
			...
			$this->width = themify_get('image_width','setting-image_post_single_width','');
                        $this->height = themify_get('image_height','setting-image_post_single_height','');
